  ...
  return (
    <div className='relative'>
      ...
      >
        ...
        <div className='font-semisemibold relative block text-center font-[poppins] text-2xl text-white sm:text-5xl'>
      ...
      <section className="relative flex aspect-[1708/517] flex-col bg-[url('/blockbg.png')] bg-center">
        ...
        <div className='flex w-full flex-col gap-2 px-8 pb-24 sm:gap-5 sm:px-60'>
          <div
            id='about'
            className='mb-10 flex border-b-[1px] border-black py-3 pt-24 font-[makro] text-4xl font-medium text-black sm:text-5xl'
          >
            About Us
          </div>
        ...
        <div className='flex w-full flex-col gap-2 px-8 py-0 sm:gap-5 sm:px-60 sm:py-24'>
          <div className='mb-10 flex border-b-[1px] border-black py-1 pb-6 font-[makro] text-4xl font-semibold text-black sm:text-5xl'>
            Spotlights
          </div>
          <div>
            <AppleGrid />
        ...
        <div className='flex w-full flex-col gap-2 px-8 py-24 sm:gap-5 sm:px-60'>
          <div className='mb-10 flex border-b-[1px] border-black py-3 pb-3 font-[makro] text-4xl font-semibold text-black sm:text-5xl'>
            Events
          </div>
        ...
        <div id='ad' className='flex w-full flex-col gap-2 px-8 py-1 sm:gap-5 sm:px-60 sm:py-24'>
          <div className='mb-10 flex border-b-[1px] border-black py-2 font-[makro] text-4xl font-semibold text-black sm:text-5xl'>
            Admission
          </div>
          <div className='flex pb-5 font-[poppins] text-lg font-normal text-black sm:text-xl'>
        ...
        {/* Research */}
        <div className='flex w-full flex-col gap-2 px-8 py-0 sm:gap-5 sm:px-60 sm:py-24'>
          <div className='mb-10 flex border-b-[1px] border-black py-3 font-[makro] text-4xl font-semibold text-black sm:text-5xl'>
            Research
          </div>
          <div className='flex pb-5 font-[poppins] text-lg font-normal text-black sm:text-xl'>
        ...
        {/* Campus Gallery */}
        <div className='flex w-full flex-col gap-2 px-8 py-0 sm:gap-5 sm:px-60 sm:py-24'>
          <div className='mb-10 flex border-b-[1px] border-black py-2 pb-5 font-[makro] text-4xl font-semibold text-black sm:text-5xl'>
            Campus Gallery
          </div>
        ...
        <div className='mt-16 flex w-full items-center justify-center py-20 sm:px-60'>
          <div className='flex font-[makro] text-2xl font-semibold text-black sm:text-5xl'>
